...
6% Какая структура действует максимально быстро к паттерну Comand, чем его можно
заменить Паттерны
...
6% Какие бы каналы синхронизации использовал при организации взаимодействия
...
12% В чем преимущества и недостатки ООП по сравнению с процедурным и
функциональным программированием ООП
...
12% Какие виды внедрения зависимости есть Spring
12% Что такое dependency injection в Spring Spring
12% Разница Spring Boot и Spring Spring
...
Поиск вопроса
Шанс Вопрос Тег
12% Что такое Servlet Servlets
6% В чем заключаются преимущества технологии сервлетов над CGI Common Gateway
Interface Servlets
...
6% Как контейнер сервлетов управляет жизненным циклом сервлета, когда и какие
...
6% Есть ли смысл определять для сервлета конструктор, каким образом лучше
инициализировать данные Servlets
6% Почему необходимо переопределить только init() метод без аргументов Servlets
6% Какие наиболее распространенные задачи выполняются в контейнере сервлетов
Servlets
...
6% Как обработать в приложении исключения, выброшенные другим сервлетом Servlets
...
6% Для чего используются атрибуты сервлетов и как происходит работа с ними
Servlets
...
6% В чем разница между PrintWriter и ServletOutputStream Servlets
6% Можно ли одновременно использовать в сервлете PrintWriter и
ServletOutputStream Servlets
6% Расскажите об интерфейсе SingleThreadModel Servlets
6% Что означает URL encoding, как это осуществить в Java Servlets
6% Какие различные методы управления сессией в сервлетах знаешь Servlets
6% Что такое cookies Servlets
6% Какие методы для работы с cookies предусмотрены в сервлетах Servlets
6% Что такое URL Rewriting Servlets
6% Зачем нужны и чем отличаются методы encodeURL() и encodeRedirectURL()
Servlets
6% Что такое «сессия» Servlets
6% Как уведомить объект в сессии, что сессия недействительна или закончилась
Servlets
6% Какой существует эффективный способ удостоверится, что все сервлеты доступны
только для пользователя с верной сессией Servlets
6% Как мы можем обеспечить transport layer security для нашего веб приложения
Servlets
6% Как организовать подключение к базе данных, обеспечить журналирование в
сервлете Servlets
6% Какие основные особенности появились в спецификации Servlet 3 Servlets
6% Какие способы аутентификации доступны сервлету Servlets
6% Что такое Java Server Pages JSP Servlets
6% Зачем нужен JSP Servlets
6% Опиши, как обрабатываются JSP страницы, начиная от запроса к серверу,
заканчивая ответом пользователю. Servlets
6% Расскажи об этапах (фазах) жизненного цикла JSP. Servlets
6% Расскажи о методах жизненного цикла JSP Servlets
6% Какие методы жизненного цикла JSP могут быть переопределены Servlets
6% Как можно предотвратить прямой доступ к JSP странице из браузера Servlets
6% Какая разница между динамическим и статическим содержимым JSP Servlets
6% Какие существуют основные типы тегов JSP Servlets
6% Что знаешь о действиях JSP Action tag и JSP Action Elements Servlets
6% Взаимодействие JSP - сервлет - JSP Servlets
6% Какие области видимости переменных существуют в JSP Servlets
6% Какие неявные, внутренние объекты и методы есть на JSP странице Servlets
6% Какие неявные объекты не доступны в обычной JSP странице Servlets
6% Что знаешь о PageContext и какие преимущества его использования Servlets
6% Как сконфигурировать параметры инициализации для JSP Servlets
6% Почему не рекомендуется использовать скриплеты, скриптовые элементы, в JSP
Servlets
...
6% Назови неявные, внутренние объекты JSP EL и их отличия от объектов JSP
Servlets
...
6% Всегда ли создается объект сессии на JSP странице, можно ли отключить его
создание Servlets
...
6% Расскажи о разнице execute executeQuary и executeApdate
...
6% Перечисли основные типы данных используемые в JDBC, как они связаны с типами
Java JDBC
...
62% Расскажи об иерархии коллекций в Java
...
12% Какую структуру данных реализуем в LinkedList Java Collections
...
12% Расскажи про сложность поиска элемента по ключу в HashMap Java Collections
...
12% Что такое коллекции и зачем они нужны Java Collections
...
12% Расскажи о скоростях доступа к элементам в HashMap при выполнении базовых
операций Java Collections
6% Что произойдет если мы в момент обхода итератором изменим коллекцию Java
Collections
6% Чем отличаются HashSet и LinkedHashSet Java Collections
6% Чем отличается comparator от comparable Java Collections
6% Слышал ли что то про Set Java Collections
6% Правда ли то что Set может хранить только уникальные значения Java
Collections
6% Что нужно сделать для того чтобы пользоваться циклом ForEach Java Collections
6% Как можно итерироваться по коллекциям Java Collections
6% Массив может итерироваться в цикле ForEach Java Collections
6% В чем разница между bucket'ом и списком Java Collections
6% Может ли быть такое что в HashMap'е окажется два одинаковых ключа Java
Collections
6% Сколько bucket'ов по умолчанию в HashMap'е Java Collections
6% Какое ограничение есть для добавления в TreeSet Java Collections
6% Как сравниваются объекты в HashSet между собой Java Collections
6% Может ли TreeSet хранить в себе null Java Collections
6% Позволяет ли HashSat принимать разнообразного типа данных объекта внутри себя
Java Collections
6% Какие знаешь основные реализации по поводу коллекции Java Collections
6% Почему ArrayList и массив "под капотом" является краеугольным камнем Java
Collections
6% Какой уровень сложности в hashset при поиске элемента Java Collections
6% Есть у List и Set что-то общее Java Collections
6% Как структурно выглядит двухсвязный список по сравнению с односвязным Java
Collections
6% В каких случаях лучше ArrayList, а в каких LinkedList Java Collections
6% Какая будет скорость доступа к элементу в LinkedList, который находится
посередине Java Collections
6% Что такое LinkedList Java Collections
6% Почему так важно использовать HashCode и Equals в HashMap Java Collections
6% Какая будет скорость взятия элемента в ArrayList'е Java Collections
6% Какой будет скорость поиска в LinkedList'е Java Collections
6% Что лучше ArrayList или LinkedList, если я хочу удалить элемент из середины
таблицы Java Collections
6% Какая скорость поиска в ArrayList'е Java Collections
6% Что такое ArrayList Java Collections
6% Какая скорость доступа к элементу в LinkedList'е по индексу Java Collections
6% Почему интерфейс Collection и Map не одинаковы , но находяться в одном
Framework Java Collections
6% Какое базовое отличие между интерфейсами Collection и List Java Collections
6% Почему для TreeSat необходимо реализовывать интерфейс Comparable Java
Collections
6% Что находиться внутри у HashSet и TreeSet Java Collections
6% Что интересного в пакете java.util.concurrent Java Collections
6% LinkedList односвязный или двухсвязный Java Collections
6% Базовые реализации List Java Collections
6% Расскажи про LinkedHashMap Java Collections
6% Откуда берется минимальное и максимальное значение int Java Collections
6% В чём разница между Fail Fast и Fail Save? Java Collections
6% Что означает LoadFactor Java Collections
6% Назови основные интерфейсы JCF и их реализации Java Collections
6% В чем разница между классами java.util.Collection и java.util.Collections
Java Collections
...
6% Что произойдет при вызове Iterator.next() без предварительного вызова
Iterator.hasNext()    Java Collections
6% Как поведёт себя коллекция, если вызвать iterator.remove()    Java
Collections
6% Как поведёт себя уже инстанциированный итератор для collection, если вызвать
collection.remove()    Java Collections
6% Как избежать ConcurrentModificationException во время перебора коллекции Java
Collections
...
6% Какое худшее время работы метода contains() для элемента, который есть в
...
6% Как происходит удаление элементов из ArrayList, как меняется в этом случае
размер ArrayList Java Collections
6% Предложи эффективный алгоритм удаления нескольких рядом стоящих элементов из
середины списка, реализуемого ArrayList Java Collections
6% Сколько необходимо дополнительной памяти при вызове ArrayList.add()    Java
Collections
6% Сколько выделяется дополнительно памяти при вызове LinkedList.add()    Java
Collections
6% Оцени количество памяти на хранение одного примитива типа byte в LinkedList
Java Collections
6% Оцени количество памяти на хранение одного примитива типа byte в ArrayList
Java Collections
6% Сравни интерфейсы Queue и Deque Java Collections
6% Кто кого расширяет: Queue расширяет Deque, или Deque расширяет Queue Java
Collections
6% Почему LinkedList реализует и List, и Deque Java Collections
6% Как перебрать элементы LinkedList в обратном порядке, не используя медленный
get(index)    Java Collections
6% Что позволяет сделать PriorityQueue Java Collections
6% Stack считается «устаревшим», чем его рекомендуют заменять, почему Java
Collections
...
6% В чем проявляется «сортированность» SortedMap, кроме того, что toString()
выводит все элементы по порядку Java Collections
6% Какова оценка временной сложности операций над элементами из HashMap,
гарантирует ли HashMap указанную сложность выборки элемента Java Collections
6% Возможна ли ситуация, когда HashMap выродится в список даже с ключами
...
6% Может ли значение в столбце, на который наложено ограничение FOREIGN KEY,
равняться NULL SQL
