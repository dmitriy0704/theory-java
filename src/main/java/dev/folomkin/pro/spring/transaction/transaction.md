...
## **Как работать с аннотациями в Spring Framework**
...
## Пример, где используется `Propagation.REQUIRES_NEW` или `rollbackFor`, чтобы лучше понять?
...
# Вызов метода с аннотацией `@Transactional` внутри другого метода, также помеченного аннотацией `@Transactional`
